...
//        getPresenter().requestLoginData(this);
    ...
    @Override
    public void onLoginSuccess(LoginBean slopeBean) {
        ARouter.getInstance().build("/map/index").withString( "operatorID" ,slopeBean.getId()+"" ).withString( "userName" ,slopeBean.getOperatorName() ).navigation();
        showLoading();//显示加载框
...
//        ARouter.getInstance().build("/map/index").withString( "operatorID" ,"zxy" ).withString( "userName" ,"测试" ).navigation();
//        showLoading();//显示加载框
//        Thread loginRunnable = new Thread() {
//            @Override
//            public void run() {
...
//        loginRunnable.start();
    ...
    private void  checkPermission(){
        ...
        permissionItems.add(new PermissionItem(Manifest.permission.ACCESS_COARSE_LOCATION, "网络定位", R.drawable.permission_ic_phone));
        permissionItems.add(new PermissionItem(Manifest.permission.WRITE_EXTERNAL_STORAGE, "手机状态", R.drawable.permission_ic_phone));
        permissionItems.add(new PermissionItem(Manifest.permission.READ_PHONE_STATE, "读写sd卡", R.drawable.permission_ic_phone));
        permissionItems.add(new PermissionItem(Manifest.permission.INTERNET, "网络访问", R.drawable.permission_ic_phone));
        permissionItems.add(new PermissionItem(Manifest.permission.CAMERA, "打开相机", R.drawable.permission_ic_phone));
        permissionItems.add(new PermissionItem(Manifest.permission.RECORD_AUDIO, "打开录音", R.drawable.permission_ic_phone));
        permissionItems.add(new PermissionItem(Manifest.permission.READ_EXTERNAL_STORAGE, "读写sd卡", R.drawable.permission_ic_phone));
