...
//        RegisterBroadcast();
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            //打卡范围
            mDestinationPoint = new LatLng(location.getLatitude()+0.01 , location.getLongitude()+0.01);//假设公司坐标
            setCircleOptions();
            //计算两点距离,单位：米
            mDistance = DistanceUtil.getDistance(mDestinationPoint, LocationPoint);
            if (mDistance <= DISTANCE) {
                //显示文字
                setTextOption(mDestinationPoint, "您已在巡查范围内", "#7ED321");
                //目的地图标
                ...
                setTextOption(LocationPoint, "您不在巡查范围之内", "#FF6C6C");
            ...
            mDistance_tv.setText("距离目的地：" +String.format("%.2f",(mDistance))+ "米");
            //缩放地图
    ...
    private void setTextOption(LatLng point, String str, String color) {
        ...
        mInfoWindow = new InfoWindow(view, point, 120);
